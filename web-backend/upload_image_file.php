<html>
    ...
    <body>
        <div id="fileUploaderDiv">
            <form action="image_file_uploader.php" method="post" enctype="multipart/form-data">
            ...
            <?php
                ...
                // output data of each row
                    while($row = mysqli_fetch_assoc($query_result)) {
                        ...
                        echo "<tr>";
                        echo "<td>" . $row["id"] . "</td><td><img src=\"" . $file . ".png\"></td><td>" . $row["firstName"]. "</td><td>" . $row["lastName"]. "</td>";
                        echo "</tr>";
